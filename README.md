...
A demonstration of this exercise is available at [https://youtu.be/sT3gL7J6c5Q](https://youtu.be/sT3gL7J6c5Q) (25 minutes)
...
The expectations for this exercise are that you will
 ...
 - [ ] Import a new story format (JTwine-to-JSON) into Twine
 ...
 - [ ] Make two specific edits to the imported JSON
...
The resulting pop-up window should read "To add a story format, enter its address below." Enter `https://cdn.githubraw.com/BL-MSCH-C220/JTwine-to-JSON/main/format.js` and press the green "+ Add" button.
...
In the Story menu at the top of the window, select Details. You should now see a pop-up in the bottom-right corner. Change the "Story Format" and select "JTwine-To-JSON 0.1.1". If you now press Build->"Play", your browser will now display a single (JSON) file containing your story.
